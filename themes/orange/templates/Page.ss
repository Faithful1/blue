<!DOCTYPE html>
<!-- The Orange Palm Company Limited-->
<!--[if !IE]><!-->
...
<head>
	...
	<link rel="shortcut icon" href="themes/orange/images/favicon.ico" />
	$MetaTags(false)
	...
	<meta name="image" content=<% if $OGImage %>"$OGImage.absoluteURL"<% else %>"http://torpalm.com/themes/orange/images/og.png"<% end_if %> />
	...
	<meta itemprop="image" content=<% if $OGImage %>"$OGImage.absoluteURL"<% else %>"http://torpalm.com/themes/orange/images/og.png"<% end_if %> />
	<%-- Twitter --%>
	...
	<meta name="twitter:image:src" content=<% if $TwitterImage %>"$TwitterImage.absoluteURL"<% else %>"http://torpalm.com/themes/orange/images/twitter.png"<% end_if %> />
	...
	<meta property="og:image" content=<% if $OGImage %>"$OGImage.absoluteURL"<% else %>"http://torpalm.com/themes/orange/images/og.png"<% end_if %> />
	<meta property="og:url" content="$AbsoluteLink" />
	<meta property="og:site_name" content="Orange Palm" />
...
<script src="$ThemeDir/javascript/orange-front.js"></script>
