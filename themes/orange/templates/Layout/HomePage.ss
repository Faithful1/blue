...
<div class="content">
	<div class="container">
		...
		<div class="row section justify-content-center align-items-center">
			<div class="col-sm-10 col-md-5 col-xl-4">
				<p class="section-title">Citizens Plantain Flour</p>
					<h6><p class="section-title">Incredible Health Benefits :</p></h6>
						<P>
							Do you want a healthy meal that will keep hypertension and stroke away,
							keep your libidos on the high,
							improve the thickness of your sperm,
							keep diabetes and excess weight at bay,
							improve your immunity while keeping your bones healthy and strong,
							switch to citizens plantain flour
							made from 100% pure unripe plantain
							by world class standards with Nafdac approval
						</P>
				<div class="row hidden-md hidden-lg hidden-xl">
					<div class="col-12">
						...
						<div class="img-mobile mx-auto">
							<img class="img-fluid hidden-sm hidden-md hidden-lg hidden-xl" src="$ThemeDir/images/activity-list-01.png" alt="Activity Card" />
						</div>
					</div>
				</div>
				...
				<%-- <div class="row hidden-md hidden-lg hidden-xl">
					<div class="col-12">
						...
						<div class="img-mobile mx-auto">
							<img class="img-fluid hidden-sm hidden-md hidden-lg hidden-xl" src="$ThemeDir/images/section-01.png" alt="Examples of Topics" />
						</div>
					</div>
				</div> --%>
		...
		<div class="row section justify-content-center align-items-center">
			<div class="col-sm-5 col-md-6 col-xl-5 hidden-xs hidden-sm">
				...
				<img class="img-fluid hidden-lg hidden-xl" src="$ThemeDir/images/activity-shadowing-01.png" alt="Job Shadowing Activity" />
			</div>
			<div class="col-sm-11 col-md-6 col-lg-5 col-xl-4">
				<p class="section-title">Citizens Beans Flour</p>
				<p>
					100% carefully sorted and selected brown beans
				</p>
					<p><a href="/articles" title="read more">Read more</a></p>
				<div class="row no-gutters">
					<div class="col-12 col-lg-11">
						...
						<div class="img-mobile mx-auto">
							<img class="img-fluid hidden-md hidden-lg hidden-xl" src="$ThemeDir/images/activity-shadowing-01.png" alt="A shadowing activity." />
						</div>
					</div>
				</div>
	...
	<span></span>
		...
		<div class="row section justify-content-center align-items-center">
			<div class="col-sm-5 col-md-6 col-xl-5 hidden-xs hidden-sm">
				<img class="img-fluid hidden-md" src="$ThemeDir/images/activity-shadowing-07.png" alt="Job Shadowing Activity" />
				<img class="img-fluid hidden-lg hidden-xl" src="$ThemeDir/images/activity-shadowing-07.png" alt="Job Shadowing Activity" />
			</div>
			<div class="col-sm-11 col-md-6 col-lg-5 col-xl-4">
				<p class="section-title">Citizens Cassava Flour</p>
				<p>
					Made from 100% whole carefully selected cassava.Very rich in carbohydrates and fiber. Enriched with vitamins
				</p>
					<p><a href="/articles" title="read more">Read more</a></p>
				<div class="row no-gutters">
					<div class="col-12 col-lg-11">
						<!-- <img class="img-fluid hidden-sm hidden-xs" src="$ThemeDir/images/activity-shadowing-05.png" alt="A shadowing activity." /> -->
						<div class="img-mobile mx-auto">
							<img class="img-fluid hidden-md hidden-lg hidden-xl" src="$ThemeDir/images/activity-shadowing-07.png" alt="A shadowing activity." />
						</div>
					</div>
				</div>
				<%-- <p><strong>Feedback is always anonymous and easy to submit.</strong></p>
	...
	<span></span>
		...
		<div class="row section justify-content-center align-items-center">
			<div class="col-sm-5 col-md-6 col-xl-5 hidden-xs hidden-sm">
				<img class="img-fluid hidden-md" src="$ThemeDir/images/activity-shadowing-09.png" alt="Job Shadowing Activity" />
				<img class="img-fluid hidden-lg hidden-xl" src="$ThemeDir/images/activity-shadowing-09.png" alt="Job Shadowing Activity" />
			</div>
			<div class="col-sm-11 col-md-6 col-lg-5 col-xl-4">
				<p class="section-title">The Palm Vita</p>
				<p>
				...
				<div class="row no-gutters">
					<div class="col-12 col-lg-11">
						<img class="img-fluid hidden-sm hidden-xs" src="$ThemeDir/images/activity-shadowing-10.png" alt="A shadowing activity." />
						<div class="img-mobile mx-auto">
							<img class="img-fluid hidden-md hidden-lg hidden-xl" src="$ThemeDir/images/activity-shadowing-09.png" alt="A shadowing activity." />
						</div>
					</div>
				</div>
				<%-- <p><strong>Feedback is always anonymous and easy to submit.</strong></p>
		...
		<!-- <div class="row section justify-content-center align-items-center">
			<div class="col-sm-10 col-md-5 col-xl-4">
				<p class="section-title">Whole WHeat Flour</p>
						<P>
							Made from 100% Whole carefully
							selected red hard wheat grain
		...
		<div class="content articles-list home-articles">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h4>Checkout Orange Palm News</h4>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-12">
						<a class="see-more" href="/articles/">View all News from The Orange Palm Limited</a>
					</div>
				</div>
			</di
			v>
		...
		<div class="row section summary">
			<div class="col-12">
				<p class="summary-title">Order now . Delivery nationwide</p>
				<p class="title">Call 09080048177 or 08179457108,</p>
				<p class="title"> ...eat right Live right</p>
