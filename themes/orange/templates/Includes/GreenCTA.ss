		...
		<div class="row justify-content-center">
			<div class="col-12">
				...
				<div class="mailchimp" id="mc_embed_signup">
					<form action="//torpalm.us15.list-manage.com/subscribe/post?u=d592b07be736db0947774b787&amp;id=22e8a5ce04" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
						<div id="mc_embed_signup_scroll">
							<label for="mce-EMAIL"><strong>Our Vision : </strong>To become a home grown global brand in the food,
								energy, nutrition, and health industry helping people live better, richer and longer</label>
