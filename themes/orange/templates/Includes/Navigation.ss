<div class="row top align-items-center">
	<div class="col-5 col-sm-4 col-lg-3">
		<!-- <a href="$BaseURL" title="The Orange Palm"><img class="img-fluid" src="$ThemeDir/images/logo-top.png" alt="The Orange palm" /></a> -->
	</div>
	<div class="col-7 col-sm-8 col-lg-9">
		<ul class="nav justify-content-end">
			...
			<% end_loop %>
			<li class="nav-item hidden-sm hidden-xs">
				<!-- <a class="nav-link" href="/#contact" title="Contact Orange Palm">Contact</a> -->
			</li>
		...
		<div>
			...
			<nav id="menu" class="panel" role="navigation">
				...
				<ul>
					...
					<li><span></span></li>
					<li>
						<a class="instagram" href="http://www.instagram.com/orangepalm" title="Follow us on Instagram">
						...
						<a class="facebook" href="http://www.facebook.com/orangepalm" title="Follow us on Facebook">
						<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42">
